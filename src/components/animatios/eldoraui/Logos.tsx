import { Marquee } from "@/components/animatios/eldoraui/marquee";
          ...
          <Marquee className="max-w-full [--duration:40s]">
            {companies.map((company, idx) => (
              <Image
                ...
                height={40}
                src={company.url}
                className="h-10 w-28 object-contain opacity-90 dark:opacity-30 dark:brightness-0 dark:grayscale dark:invert"
                alt={company.name}
              />
            ))}
          </Marquee>
